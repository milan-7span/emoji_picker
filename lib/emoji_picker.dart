    ...
    if (widget.recommendKeywords != null) {
      allNames.forEach((name) {
        ...
        if (numSplitEqualKeyword > 0) {
          ...
          recommendedEmojis
              .add(_Recommended(name: name, emoji: allEmojis[allNames.indexOf(name)], tier: 3, numSplitPartialKeyword: numSplitPartialKeyword));
        }
      });
                  ...
                  case ButtonMode.MATERIAL:
                    return Center(
                      ...
                      onPressed: () {
                        ...
                        widget.onEmojiSelected(Emoji(name: emojiName, emoji: allEmojis[allNames.indexOf(emojiName)]), widget.selectedCategory);
                      },
                    ));
  ...
  Widget build(BuildContext context) {
    if (loaded) {
      ...
      if (widget.selectedCategory == Category.RECOMMENDED) {
        ...
        pageController =
            PageController(initialPage: smileyPagesNum + animalPagesNum + foodPagesNum + travelPagesNum + recentPagesNum + recommendedPagesNum);
      } else if (widget.selectedCategory == Category.OBJECTS) {
        pageController = PageController(
            initialPage: smileyPagesNum + animalPagesNum + foodPagesNum + travelPagesNum + activityPagesNum + recentPagesNum + recommendedPagesNum);
          ...
          SizedBox(
            ...
            child: PageView(
                ...
                onPageChanged: (index) {
                  ...
                  } else if (index < recentPagesNum + smileyPagesNum + animalPagesNum + foodPagesNum + travelPagesNum + recommendedPagesNum) {
                    widget.selectedCategory = Category.TRAVEL;
                  } else if (index <
                      recentPagesNum + smileyPagesNum + animalPagesNum + foodPagesNum + travelPagesNum + activityPagesNum + recommendedPagesNum) {
                        ...
                        ? SizedBox(
                            ...
                            child: widget.buttonMode == ButtonMode.MATERIAL
                                ? TextButton(
                                    style: TextButton.styleFrom(
                                      padding: EdgeInsets.all(0),
                                      primary: widget.selectedCategory == Category.RECOMMENDED ? Colors.black12 : Colors.transparent,
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.RECENT ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.SMILEYS ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.ANIMALS ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.FOODS ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.TRAVEL ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
                              ...
                              onPressed: () {
                                ...
                                pageController!.jumpToPage(recentPagesNum + smileyPagesNum + animalPagesNum + foodPagesNum + recommendedPagesNum);
                              },
                            )
                          : CupertinoButton(
                              pressedOpacity: 0.4,
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.ACTIVITIES ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.OBJECTS ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.SYMBOLS ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
                    ...
                    SizedBox(
                      ...
                      child: widget.buttonMode == ButtonMode.MATERIAL
                          ? TextButton(
                              style: TextButton.styleFrom(
                                padding: EdgeInsets.all(0),
                                primary: widget.selectedCategory == Category.FLAGS ? Colors.black12 : Colors.transparent,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(0))),
                              ),
                              child: Center(
                                child: Icon(
...
class _ProgressPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (selectedCategory == Category.RECOMMENDED) {
      ...
      offsetInPages = (pageController.offset - ((pages[Category.RECOMMENDED]! + pages[Category.RECENT]!) * actualPageWidth)) / actualPageWidth;
      ...
      offsetInPages = (pageController.offset -
              ((pages[Category.RECOMMENDED]! + pages[Category.RECENT]! + pages[Category.SMILEYS]! + pages[Category.ANIMALS]!) * actualPageWidth)) /
          actualPageWidth;
